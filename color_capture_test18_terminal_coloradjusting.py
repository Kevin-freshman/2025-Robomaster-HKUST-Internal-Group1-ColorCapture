...
class OptimizedColorDetector:
    def __init__(self):
        self.color_ranges = {
            ...
            'Gold': [([15, 90, 130], [35, 255, 255])],
            'Silver': [([0, 0, 180], [180, 50, 255])],
            'Mineral_Gray': [([0, 0, 30], [180, 40, 140])]
        }
        ...
        for port_num in range(10, 20):
            ...
            try:
                ...
                print(f"serial open successfully!Connected to {port_name}")
                self.ser.write(b"hello_serial\r\n")
                print("sending test message:hello_serial")
                break 
